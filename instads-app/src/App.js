...
class App extends React.Component {
  ...
  login(authData) {
    this._api.login(authData).then(() => this.closeLoginModal())
  }
  signup(signupData) {
    this._api.signup(signupData).then(() => this.closeSignupModal())
  }
  render() {
          ...
          <nav className='nav'>
            <div className='nav__row'>
              ...
              <div className='nav__list'>
                ...
                <button onClick={this.openSignupModal} className='join trigger'>
